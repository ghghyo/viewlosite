                            ...
                            <Col className="col-12 col-lg-2 d-flex justify-content-between align-items-center">
                                ...
                                <div className="logo">
                                    ...
                                    <Link href="/" className="navbar-brand navbar-brand1">
                                        <img src="/images/viewlologogreen.png" srcSet={`/images/viewlologogreen.png 2x`} alt="ViewLo" />
                                    </Link>

                                    <Link href="/" className="navbar-brand navbar-brand2">
                                        <img src="/images/viewlologo.jpg" srcSet={`/images/viewlologo.jpg 2x`} alt="ViewLo" />
                                    </Link>
